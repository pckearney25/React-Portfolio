            ...
            <div className="post-container">
              ...
              <div className="content-div">
                <p className="content-regular-paragraph">
                  {`On the “About” page of my website I described myself as “a career chemist transitioning into web-development”.  However, when I say this in conversation, I often get a confused look and the response: “Why would you `}
                  <span className="content-span-italic">{`EVER `}</span>
                  {`want to do that?”.  Now, that is a valid question, since my last programming course was back when “The Reflex” by Duran Duran topped the charts, but I hate that my answer isn’t as sharp as I would I like.`}
                </p>

                <p className="content-regular-paragraph">
                  {`Since the major goal of my career transition is, well, employment, I decided to refine my personal pitch by first answering some common interview questions. (And who doesn’t enjoy answering some of these classic chestnuts?!!) During this exercise, I realized that my answers were a both a good way to learn about me and to kick off the blog, so I thought I would share them here.  Let’s go!`}
                </p>
                ...
                <p className="content-indented-paragraph">{`I’m a lifelong scientist, and I believe that experimentation and data analysis are vital for creating new things and making informed choices.  I honed my scientific skills and developed my executive skills in the pharmaceutical industry, where I’ve led teams that have identified three clinical candidates and brought in millions of dollars in corporate revenue through chemical compound sales. After I moved to Kansas City, I used my knowledge of science and business to start a company, HD Sciences, that was developing a microscale chemical synthesis technology for use in drug discovery. Unfortunately, like most first time entrepreneurs, I failed but learned valuable lessons.`}</p>
                ...
                <p className="content-indented-paragraph">{`When I was working in the pharmaceutical industry, I knew that I had a strong interest in both science and business, and that someday I would take a shot at starting my own.  After I needed to find a new position at a time when that industry was shedding tens of thousands of skilled researchers globally, I took that shot and I started a chemistry-based business aimed at drug discovery researchers.  Years of hard work later, I still I loved entrepreneurship but realized that the company was doomed. So, I thought about other businesses I could enter. I also no longer wanted to be defined by the career decisions I made decades ago and had become a bit disillusioned with the drug discovery business in general.`}</p>
